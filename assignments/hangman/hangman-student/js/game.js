var word = {
  ...
  checkLetters: function(guessedLetters){
    if (_.contains(this.secretWord, guessedLetters)) {
      this.matchedLetters.push(guessedLetters);
    } else {
      this.mismatchedLetters.push(guessedLetters);
    }
      this.alphabet.push(guessedLetters);
    }
};
